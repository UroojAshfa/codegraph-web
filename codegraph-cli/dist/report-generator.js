...
class ReportGenerator {
    generateHTMLReport(graph, complexity, fileCount, projectName) {
        const data = this.prepareReportData(graph, complexity, fileCount, projectName);
        return this.buildHTML(data);
    }
    prepareReportData(graph, complexity, fileCount, projectName) {
...
<body>
    ...
    saveHTMLReport(html, outputPath) {
